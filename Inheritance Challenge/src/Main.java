public class Main {
    ...
    public static void main (String[] args) {
        ...
        System.out.println ("Joe's Paycheck = $" + yash.collectPay ());

        yash.retire ();
        System.out.println ("Joe's Pension check = $" + yash.collectPay ());

        HourlyEmployee swati = new HourlyEmployee ("Swati", "24/02/2000", "03/03/2021", 15);
        System.out.println (swati);
        System.out.println ("Mary's Paycheck = $" + swati.collectPay ());
        System.out.println ("Mary's Holiday Pay = $" + swati.getDoublePay ());
    }
}
